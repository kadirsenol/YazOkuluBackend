...
{
    public class Repository<T>(YazOkuluDbContext _db, IHttpContextAccessor _contextAccessor, bool _isAudit = false) : IRepository<T> where T : BaseEntity
    {
        private readonly YazOkuluDbContext db = _db;
